...
const TechnicalSkills = ({ activeRole }) => {
  const currentProfile = profiles[activeRole] || profiles.software_engineer;
  const currentSkills = currentProfile.technicalSkills || { categories: [] };
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" className="mb-16 text-center">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            A comprehensive overview of my programming languages, tools, frameworks, and core engineering workflows.
          </p>
        </div>
