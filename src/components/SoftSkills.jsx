...
const SoftSkills = ({ activeRole }) => {
  const currentProfile = profiles[activeRole] || profiles.software_engineer;
  const softSkillsList = currentProfile.softSkillsList || [];
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-lg mx-auto leading-relaxed">
            Essential traits and workflows that make me an effective developer, analyst, and team member.
          </p>
        </div>
