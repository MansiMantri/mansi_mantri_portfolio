...
import { profiles, socialLinks } from '../data/portfolioData';
...
const Projects = ({ activeRole }) => {
  const currentProfile = profiles[activeRole] || profiles.software_engineer;
  const activeProjects = currentProfile.projects || [];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-lg font-medium leading-relaxed">
            A selection of projects that showcase my expertise in full-stack development, ML, and scalable architecture.
          </p>
        </div>
